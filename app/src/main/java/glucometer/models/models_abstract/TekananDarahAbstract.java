...
public abstract class TekananDarahAbstract {
    ...
    public TekananDarahAbstract(int tekananSistolik, int tekananDiastolik, String tangan, String catatan, String tanggal) {
